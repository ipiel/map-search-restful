...
public class PoiController {
	...
	public List<Poi> list(Model model, @RequestParam(required = false) String fromLong,
			@RequestParam(required = false) String toLong, @RequestParam(required = false) String fromLat,
